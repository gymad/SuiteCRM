...
(function () {
  ...
  SUGAR.EmailAddressWidget.prototype = {
    ...
    addEmailAddress: function (tableId, address, primaryFlag, replyToFlag, optOutFlag, optInFlag, invalidFlag, emailId) {
      ...
      newContentOptInFlag['onClick'] = function () {
        this.eaw.toggleCheckbox(this)
      };
      ...
      newContent.eaw = this;
      newContent.onblur = function (e) {
        this.eaw.retrieveEmailAddress(e)
      };
      newContent.onkeydown = function (e) {
        this.eaw.handleKeyDown(e)
      };
      ...
      if (YAHOO.env.ua.ie > 0) {
        ...
        YAHOO.util.Event.addListener(newContent, "change",
          function (ev, el) {
            SUGAR.util.callOnChangeListers(el);
          }, emailcontainer
        );
      }
