...
<div class="col-xs-12">
    <div class="col-xs-12 email-address-add-line-container emailaddresses" id="{$module}emailAddressesTable{$index}">
        ...
        <button type="button" class="btn btn-info email-address-add-button"
            ...
            <div class="col-xs-12 col-sm-6 email-address-options-container">
                ...
                {if $useOptIn == true}
                    <div class="col-xs-3 col-sm-2 col-md-2 col-lg-2 text-center email-address-option">
                        ...
                        <div><input type="checkbox" name="" title="{$app_strings.LBL_ID_FF_OPT_IN}"
                                    id="email-address-opt-in-flag" class="email-address-opt-in-flag" value=""
                                    enabled="true"></div>
                    </div>
                {/if}
                ...
                {if $useInvalid == true}
                    <div class="col-xs-3 col-sm-2 col-md-2 col-lg-2 text-center email-address-option">
                        ...
                        <div><input type="checkbox" name="" title="{$app_strings.LBL_ID_FF_INVALID}"
